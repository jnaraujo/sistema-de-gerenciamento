...
public class InstallationServiceComponent {
    public static HBox create(InstallationService service, EventHandler onUpdateButtonClick, EventHandler onDeleteButtonClick) {
        HBox hBox = new HBox();
